...
export function SitemarkIcon() {
  return (
      <SvgIcon sx={{ height: 24, width: 120, mr: 2 }} viewBox="0 0 512 512">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            fill="currentColor"
        >
          <path d="M384 192c0-53.02-42.98-96-96-96-35.29 0-66.2 19.18-82.7 47.72l-51.06-29.49c-15.28-8.82-34.91-3.57-43.73 11.72s-3.57 34.91 11.72 43.73L166.3 208l-48.07 27.74c-15.28 8.82-20.53 28.45-11.72 43.73s28.45 20.53 43.73 11.72l51.06-29.49C221.8 292.82 252.7 312 288 312c53.02 0 96-42.98 96-96z" fill="#00BFA5"/>
          <text x="160" y="420" fontSize="72" fontWeight="bold" fill="#1a237e" fontFamily="Arial, sans-serif">
            Sponsoa
          </text>
        </svg>
      </SvgIcon>
