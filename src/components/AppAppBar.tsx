      ...
      <Container maxWidth="lg">
        <StyledToolbar variant="dense" disableGutters>
          ...
          >
            ...
            <Button color="primary" variant="contained" size="small" onClick={onSignUpClick}>
              Sign up
            </Button>
          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: 'background.default' }}>
                ...
                <Divider sx={{ my: 3 }} />
                <MenuItem>
                  <Button color="primary" variant="contained" fullWidth onClick={onSignUpClick}>
                    Sign up
                  </Button>
                </MenuItem>
                <MenuItem>
                  <Button color="primary" variant="outlined" fullWidth onClick={onSignInClick}>
                    Sign in
                  </Button>
                </MenuItem>
              </Box>
